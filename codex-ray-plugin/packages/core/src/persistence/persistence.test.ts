...
describe("persistence", () => {
  ...
  describe("saveGraph / loadGraph", () => {
    it("should write knowledge-graph.json to .codex-ray/", () => {
      saveGraph(tempDir, sampleGraph);

      const filePath = join(tempDir, ".codex-ray", "knowledge-graph.json");
  ...
  describe("saveMeta / loadMeta", () => {
    it("should write meta.json to .codex-ray/", () => {
      saveMeta(tempDir, sampleMeta);

      const filePath = join(tempDir, ".codex-ray", "meta.json");
      expect(existsSync(filePath)).toBe(true);
    });
  ...
  describe("saveFingerprints / loadFingerprints", () => {
    ...
    it("should return null when fingerprints.json is corrupted", () => {
      const dir = join(tempDir, ".codex-ray");
