 ...
 * (Phase 7 step 2.5), generating .codex-ray/fingerprints.json.
 *
 ...
 *
 * Writes: <projectRoot>/.codex-ray/fingerprints.json
...
// ---------------------------------------------------------------------------
// Resolve @codex-ray/core (matches extract-structure.mjs).
