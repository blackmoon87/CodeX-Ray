...
- If a knowledge graph already exists (`.codex-ray/knowledge-graph.json`), derives domain knowledge from it (cheap, no file scanning)
...
1. Check if `$PROJECT_ROOT/.codex-ray/knowledge-graph.json` exists
...
1. Run the preprocessing script bundled with this skill, passing `$PROJECT_ROOT` from Phase 0:
   ...
   ```
   This outputs `$PROJECT_ROOT/.codex-ray/intermediate/domain-context.json` containing:
...
1. Read `$PROJECT_ROOT/.codex-ray/knowledge-graph.json`
...
3. The agent writes its output to `$PROJECT_ROOT/.codex-ray/intermediate/domain-analysis.json`
...
4. Save to `$PROJECT_ROOT/.codex-ray/domain-graph.json`
5. Clean up `$PROJECT_ROOT/.codex-ray/intermediate/domain-analysis.json` and `$PROJECT_ROOT/.codex-ray/intermediate/domain-context.json`
