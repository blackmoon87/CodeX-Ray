...
Answer questions about this codebase using the knowledge graph at `.codex-ray/knowledge-graph.json`.
...
1. Check that `.codex-ray/knowledge-graph.json` exists in the current project root. If not, tell the user to run `/understand` first.
